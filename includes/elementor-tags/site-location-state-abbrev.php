<?php
/**
 * Elementor Dynamic Tag: Site Location State Abbreviation
 *
...
/**
 * Site Location State Abbreviation Tag.
 *
 * @since 2.3.0
 */
class ACF_SMS_Site_Location_State_Abbrev_Tag extends \Elementor\Core\DynamicTags\Tag {
	...
	public function get_name() {
		return 'acf-sms-site-location-state-abbrev';
	}
	...
	public function get_title() {
		return __( 'Site Location: State Abbreviation', 'acf-sms' );
	}
	...
	public function render() {
		echo esc_html( $this->site_settings->get_location_field( 'location_state_abbrev' ) );
	}
}
